...
pu.plot_time_series(flight_data, results["nis"], ax)
pu.plot_time_series(flight_data, results["mahalanobis_distance"], ax)
pu.plot_time_series(flight_data, results["norm_epsilon_norm"], ax, plot_phase=True)
