...
from utils import TIME_RANGE_2019_CIRCLES, TIME_RANGE_2025_CIRCLES
...
def main(color_by: str | bool = "tether_force_kite") -> None:
    ...
    df_2019 = load_and_process_data(
        ...
        kite_model="v3",
        addition="_t26",
        time_range=TIME_RANGE_2019_CIRCLES,  # (1800.0, 9986.2),
        downsample_frac=1.0,
    )
    df_2025 = load_and_process_data(
        ...
        kite_model="v3",
        addition="",
        time_range=TIME_RANGE_2025_CIRCLES,  # (400.0, 1000.0),
        downsample_frac=1.0,
    )
    ...
    output_path = (
        Path(__file__).resolve().parent / "results" / "yz_plane_lemniscate.pdf"
    )
